    ...
    >
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-8 relative z-30 space-y-12">
        ...
        >
          <motion.button
            onClick={() => {
              ...
              navigate('/what-if', { state: { level: currentLevel } });
            }}
        ...
        >
          ...
          >
            Sentence <span className="text-5xl">Practice</span>
          </motion.h1>
          <p className="text-xl text-white/70 max-w-4xl mx-auto leading-relaxed">
            Practice repeating sentences with AI feedback. Powered by Gemini API.
          </p>
        </motion.div>
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="flex items-center justify-center gap-6">
                  ...
                  <motion.button
                    ...
                    className="p-6 rounded-full shadow-lg bg-gradient-to-r from-cyan-500 to-teal-500 hover:opacity-90"
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.95 }}
