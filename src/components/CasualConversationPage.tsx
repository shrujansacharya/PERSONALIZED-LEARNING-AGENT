...
import { Mic, Volume2, ArrowLeft, RefreshCw, User, Bot, MessageSquare, Send, Brain, BookOpen, MessageSquare as MessageSquareIcon, Mic as MicIcon, Award, Star, Trophy, Flame, Zap, Sparkles, Coffee, Target, Volume, Play, Pause, Globe, Headphones, Lightbulb, Heart, ChevronRight, Settings } from 'lucide-react';
...
export const CasualConversationPage = () => {
  ...
  // Stop bot voice when component unmounts (user exits page)
  useEffect(() => {
    return () => {
    ...
    >
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-8 relative z-30 space-y-12">
        ...
        >
          ...
          >
            Casual <span className="text-5xl">Conversation</span>
          </motion.h1>
                    ...
                    >
                      ...
                      >
                        <div className="font-semibold mb-1">
                          {msg.role === 'user' ? 'You:' : msg.role === 'bot' ? 'AI Friend:' : 'Feedback:'}
                        </div>
                        {msg.text}
                      </div>
                      {msg.role === 'user' && (
